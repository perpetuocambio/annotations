...
graph LR
    ...
    A --> C["Antropología Cultural / Social<br/>(finales s. XIX)"]
    A --> D["Arqueología<br/>(rama material)"]
    A --> E["Antropología Lingüística<br/>(principios s. XX)"]
    A --> I["Antropologías Críticas, Decoloniales<br/>y de los Pueblos Originarios<br/>(1950s-2026, transversal)"]

    B --> B1["Primatología"]
    B --> B2["Paleoantropología"]
    B --> B3["Antropología Forense"]
    B --> B4["Genética de poblaciones humanas"]
    B --> B5["Antropología Multiespecies<br/>(2010s-2026)"]

    C --> C1["Antropología Económica"]
    C --> C1b["Neoevolucionismo<br/>White, Service (1950s-60s)"]
    C --> C1c["Don Melanesio<br/>Wagner, Strathern"]
    C --> C1d["Materialismo Cultural<br/>Marvin Harris"]
    C --> C2["Antropología Política"]
    C --> C2m["Escuela de Manchester<br/>(1950s-60s)"]
    C --> C2d["Antropología del Estado<br/>Gupta, Foucault"]
    C --> C2b["Barth: Transaccionalismo<br/>y Fronteras Étnicas (1969)"]
    C --> C2c["Etnografía Soviética<br/>concepto de Etnos"]
    C --> C3["Antropología de la Religión"]
    C --> C3b["Chamanismo Circumpolar<br/>Siberia"]
    C --> C4["Antropología del Parentesco"]
    C --> C4b["Dumont: Jerarquía<br/>Homo Hierarchicus (1966)"]
    C --> C5["Antropología Simbólica e Interpretativa<br/>(1960s-70s)"]
    C --> C5b["Antropología de la Performance<br/>Schechner, Goffman"]
    C --> C6["Antropología Médica<br/>(1950s en adelante)"]
    C --> C7["Antropología Urbana<br/>(1930s Escuela de Chicago)"]
    C --> C8["Antropología Ambiental / Ecológica<br/>(1950s-60s)"]
    C --> C9["Antropología Visual<br/>(1920s-40s)"]
    C --> C10["Antropología Feminista y de Género<br/>(1970s)"]
    C --> C10q["Antropología Queer<br/>(1980s-90s)"]
    C --> C11["Antropología Cognitiva<br/>(1950s-60s)"]
    C --> C11p["Antropología Psicológica<br/>Cultura y Personalidad (1930s-50s)"]
    C --> C12["Antropología Posmoderna / Reflexiva<br/>(1980s)"]
    C --> C13["Antropología Multiespecies / Ontológica<br/>(2000s-2026)"]
    C --> C14["Antropología del Desarrollo<br/>(1950s-60s)"]
    C --> C15["Antropología Jurídica<br/>(1920s en adelante)"]
    C --> C16["Antropología del Cuerpo y las Emociones<br/>(1980s)"]
    C --> C17["Antropología de la Alimentación<br/>(1980s)"]
    C --> C18["Antropología de la Migración y las Diásporas<br/>(1990s)"]
    C --> C19["Antropología Histórica<br/>(1970s-80s)"]
    C --> C20["Antropología de la Ciencia y la Tecnología<br/>(1980s, STS)"]
    C --> C21["Antropología del Arte<br/>(1990s)"]
    C --> C22["Antropología de la Educación<br/>(1970s)"]
    C --> C23["Antropología de la Infancia<br/>(1990s-2000s)"]
    C --> C24["Antropología del Turismo<br/>(1970s-80s)"]

    D --> D1["Arqueología Procesual<br/>(1960s)"]
    D --> D2["Arqueología Posprocesual<br/>(1980s)"]
    D --> D2b["Arqueología Feminista<br/>Conkey, Gero"]
    D --> D3["Bioarqueología"]
    D --> D4["Arqueología Subacuática"]
    D --> D5["Etnoarqueología"]

    E --> E1["Sociolingüística"]
    E --> E2["Etnografía del Habla"]
    E --> E3["Antropología Lingüística Cognitiva"]

    I --> I1["Antropología Marxista y<br/>Economía Política"]
    I --> I2["Antropología Anarquista<br/>y Antiestatista"]
    I --> I3["Antropología Poscolonial<br/>y Decolonial"]
    I --> I4["Antropología desde los<br/>Pueblos Originarios (voz propia)"]
    I --> I5["Antropología Afrocaribeña<br/>y Latinoamericana Crítica"]
    I --> I7["Giro Pluriversal /<br/>Cosmopolítica (2010s-2026)"]

    C6 --> F1["Antropología Aplicada<br/>(1940s en adelante)"]
    C7 --> F1
    C14 --> F1
    C11 --> G1["Antropología Cognitiva Evolutiva"]
    C12 --> H1["Antropología Digital / Ciberantropología<br/>(1990s-2000s)"]
    H1 --> H2["Antropología de la IA y de las Plataformas<br/>(2010s-2026)"]
    C8 --> H3["Antropología del Antropoceno<br/>(2010s-2026)"]
    I3 --> H3
    I7 --> C13

    style A fill:#4a5568,color:#fff,stroke:#2d3748,stroke-width:2px
    style B fill:#2b6cb0,color:#fff
    style C fill:#2f855a,color:#fff
    style D fill:#c05621,color:#fff
    style E fill:#805ad5,color:#fff
    style I fill:#b83280,color:#fff
```
